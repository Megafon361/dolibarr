...
--
-- Host: localhost    Database: c1481397_doliba
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `llx_accounting_account` (
  ...
  `fk_pcg_version` varchar(32) CHARACTER SET latin1 NOT NULL,
  `pcg_type` varchar(20) CHARACTER SET latin1 NOT NULL,
  `account_number` varchar(32) CHARACTER SET latin1 NOT NULL,
  `account_parent` int(11) DEFAULT '0',
  `label` varchar(255) CHARACTER SET latin1 NOT NULL,
  `labelshort` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `fk_accounting_category` int(11) DEFAULT '0',
  `fk_user_author` int(11) DEFAULT NULL,
  `fk_user_modif` int(11) DEFAULT NULL,
  `active` tinyint(4) NOT NULL DEFAULT '1',
  `reconcilable` tinyint(4) NOT NULL DEFAULT '0',
  `import_key` varchar(14) CHARACTER SET latin1 DEFAULT NULL,
  `extraparams` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  PRIMARY KEY (`rowid`),
...
) ENGINE=InnoDB AUTO_INCREMENT=100404722 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE IF NOT EXISTS `llx_accounting_bookkeeping` (
  ...
  `doc_type` varchar(30) CHARACTER SET latin1 NOT NULL,
  `doc_ref` varchar(300) CHARACTER SET latin1 NOT NULL,
  `fk_doc` int(11) NOT NULL,
  `fk_docdet` int(11) NOT NULL,
  `thirdparty_code` varchar(32) CHARACTER SET latin1 DEFAULT NULL,
  `subledger_account` varchar(32) CHARACTER SET latin1 DEFAULT NULL,
  `subledger_label` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `numero_compte` varchar(32) CHARACTER SET latin1 NOT NULL,
  `label_compte` varchar(255) CHARACTER SET latin1 NOT NULL,
  `label_operation` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `debit` double(24,8) NOT NULL,
  `credit` double(24,8) NOT NULL,
  `montant` double(24,8) DEFAULT NULL,
  `sens` varchar(1) CHARACTER SET latin1 DEFAULT NULL,
  `multicurrency_amount` double(24,8) DEFAULT NULL,
  `multicurrency_code` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `lettering_code` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  ...
  `code_journal` varchar(32) CHARACTER SET latin1 NOT NULL,
  `journal_label` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=853 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE IF NOT EXISTS `llx_accounting_bookkeeping_tmp` (
  ...
  `subledger_account` varchar(32) CHARACTER SET latin1 DEFAULT NULL,
  `subledger_label` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `numero_compte` varchar(32) CHARACTER SET latin1 DEFAULT NULL,
  `label_compte` varchar(255) CHARACTER SET latin1 NOT NULL,
  `label_operation` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `debit` double(24,8) NOT NULL,
  `credit` double(24,8) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `llx_accounting_fiscalyear` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `label` varchar(128) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `llx_accounting_system` (
  ...
  `pcg_version` varchar(32) COLLATE utf8_spanish_ci NOT NULL,
  `label` varchar(128) CHARACTER SET latin1 NOT NULL,
  `active` smallint(6) DEFAULT '0',
  PRIMARY KEY (`rowid`),
...
CREATE TABLE IF NOT EXISTS `llx_actioncomm` (
  ...
  `ref_ext` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `entity` int(11) NOT NULL DEFAULT '1',
  ...
  `visibility` varchar(12) CHARACTER SET latin1 DEFAULT 'default',
  `fulldayevent` smallint(6) NOT NULL DEFAULT '0',
  `percent` smallint(6) NOT NULL DEFAULT '0',
  `location` varchar(128) CHARACTER SET latin1 DEFAULT NULL,
  `durationp` double DEFAULT NULL,
  `label` varchar(255) CHARACTER SET latin1 NOT NULL,
  `note` mediumtext COLLATE utf8_spanish_ci,
  `calling_duration` int(11) DEFAULT NULL,
  `email_subject` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `email_msgid` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `email_from` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `email_sender` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `email_to` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `email_tocc` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `email_tobcc` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `errors_to` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `reply_to` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `recurid` varchar(128) CHARACTER SET latin1 DEFAULT NULL,
  `recurrule` varchar(128) CHARACTER SET latin1 DEFAULT NULL,
  ...
  `elementtype` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `import_key` varchar(14) CHARACTER SET latin1 DEFAULT NULL,
  `extraparams` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `ip` varchar(250) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2583 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE IF NOT EXISTS `llx_actioncomm_reminder` (
  ...
  `typeremind` varchar(32) CHARACTER SET latin1 NOT NULL,
  `fk_user` int(11) NOT NULL,
  `offsetvalue` int(11) NOT NULL,
  `offsetunit` varchar(1) CHARACTER SET latin1 NOT NULL,
  `status` int(11) NOT NULL DEFAULT '0',
  `lasterror` varchar(128) CHARACTER SET latin1 DEFAULT NULL,
  `entity` int(11) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `llx_actioncomm_resources` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `fk_actioncomm` int(11) NOT NULL,
  `element_type` varchar(50) CHARACTER SET latin1 NOT NULL,
  `fk_element` int(11) NOT NULL,
  `answer_status` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `llx_adherent` (
  ...
  `ref` varchar(30) CHARACTER SET latin1 NOT NULL,
  `entity` int(11) NOT NULL DEFAULT '1',
  `ref_ext` varchar(128) CHARACTER SET latin1 DEFAULT NULL,
  `gender` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
  `civility` varchar(6) CHARACTER SET latin1 DEFAULT NULL,
  ...
  `pass_crypted` varchar(128) CHARACTER SET latin1 DEFAULT NULL,
  `fk_adherent_type` int(11) NOT NULL,
  `morphy` varchar(3) CHARACTER SET latin1 NOT NULL,
  `societe` varchar(128) CHARACTER SET latin1 DEFAULT NULL,
  `fk_soc` int(11) DEFAULT NULL,
  `address` text CHARACTER SET latin1,
  `zip` varchar(30) CHARACTER SET latin1 DEFAULT NULL,
  `town` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `state_id` int(11) DEFAULT NULL,
  `country` int(11) DEFAULT NULL,
  `email` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `url` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `socialnetworks` text CHARACTER SET latin1,
  `phone` varchar(30) CHARACTER SET latin1 DEFAULT NULL,
  `phone_perso` varchar(30) CHARACTER SET latin1 DEFAULT NULL,
  `phone_mobile` varchar(30) CHARACTER SET latin1 DEFAULT NULL,
  `birth` date DEFAULT NULL,
  `photo` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `statut` smallint(6) NOT NULL DEFAULT '0',
  `public` smallint(6) NOT NULL DEFAULT '0',
  `datefin` datetime DEFAULT NULL,
  `default_lang` varchar(6) COLLATE utf8_spanish_ci DEFAULT NULL,
  `note_private` text CHARACTER SET latin1,
  `note_public` text CHARACTER SET latin1,
  `model_pdf` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  ...
  `canvas` varchar(32) CHARACTER SET latin1 DEFAULT NULL,
  `import_key` varchar(14) CHARACTER SET latin1 DEFAULT NULL,
  `ip` varchar(250) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`rowid`),
...
CREATE TABLE IF NOT EXISTS `llx_adherent_type` (
  ...
  `morphy` varchar(3) CHARACTER SET latin1 NOT NULL,
  `duration` varchar(6) CHARACTER SET latin1 DEFAULT NULL,
  `subscription` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT '1',
  `amount` double(24,8) DEFAULT NULL,
  `caneditamount` int(11) DEFAULT '0',
  `vote` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT '1',
  `note` text CHARACTER SET latin1,
  `mail_valid` text CHARACTER SET latin1,
  PRIMARY KEY (`rowid`),
...
CREATE TABLE IF NOT EXISTS `llx_adherent_type_lang` (
  ...
  `lang` varchar(5) CHARACTER SET latin1 NOT NULL DEFAULT '0',
  `label` varchar(255) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `llx_asset` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `ref` varchar(128) CHARACTER SET latin1 NOT NULL,
  `entity` int(11) NOT NULL DEFAULT '1',
  ...
  `fk_user_modif` int(11) DEFAULT NULL,
  `last_main_doc` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `import_key` varchar(14) CHARACTER SET latin1 DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_asset_accountancy_codes_economic` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `fk_asset` int(11) DEFAULT NULL,
  `fk_asset_model` int(11) DEFAULT NULL,
  `asset` varchar(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `depreciation_asset` varchar(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `depreciation_expense` varchar(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `value_asset_sold` varchar(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `receivable_on_assignment` varchar(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `proceeds_from_sales` varchar(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `vat_collected` varchar(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `vat_deductible` varchar(32) COLLATE utf8_spanish_ci DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_asset_accountancy_codes_fiscal` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `fk_asset` int(11) DEFAULT NULL,
  `fk_asset_model` int(11) DEFAULT NULL,
  `accelerated_depreciation` varchar(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `endowment_accelerated_depreciation` varchar(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `provision_accelerated_depreciation` varchar(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `fk_user_modif` int(11) DEFAULT NULL,
  PRIMARY KEY (`rowid`),
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_asset_depreciation` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `fk_asset` int(11) NOT NULL,
  `depreciation_mode` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `ref` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `depreciation_date` datetime NOT NULL,
  `depreciation_ht` double(24,8) NOT NULL,
  `cumulative_depreciation_ht` double(24,8) NOT NULL,
  `accountancy_code_debit` varchar(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `accountancy_code_credit` varchar(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `fk_user_modif` int(11) DEFAULT NULL,
  PRIMARY KEY (`rowid`),
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_asset_depreciation_options_economic` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `fk_asset` int(11) DEFAULT NULL,
  `fk_asset_model` int(11) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_asset_depreciation_options_fiscal` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `fk_asset` int(11) DEFAULT NULL,
  `fk_asset_model` int(11) DEFAULT NULL,
  `depreciation_type` smallint(6) NOT NULL DEFAULT '0',
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_asset_model` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `entity` int(11) NOT NULL DEFAULT '1',
  `ref` varchar(128) COLLATE utf8_spanish_ci NOT NULL,
  ...
  `note_private` text COLLATE utf8_spanish_ci,
  `date_creation` datetime NOT NULL,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `fk_user_creat` int(11) NOT NULL,
  `fk_user_modif` int(11) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_asset_model_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) COLLATE utf8_spanish_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `llx_bank` (
  ...
  `fk_type` varchar(6) CHARACTER SET latin1 DEFAULT NULL,
  `num_releve` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `num_chq` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `numero_compte` varchar(32) CHARACTER SET latin1 DEFAULT NULL,
  `rappro` tinyint(4) DEFAULT '0',
  `note` text CHARACTER SET latin1,
  `fk_bordereau` int(11) DEFAULT '0',
  `banque` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `emetteur` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `author` varchar(40) CHARACTER SET latin1 DEFAULT NULL,
  `origin_id` int(11) DEFAULT NULL,
  `origin_type` varchar(64) CHARACTER SET latin1 DEFAULT NULL,
  `import_key` varchar(14) CHARACTER SET latin1 DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=665 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE IF NOT EXISTS `llx_bank_account` (
  ...
  `datec` datetime DEFAULT NULL,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ref` varchar(12) CHARACTER SET latin1 NOT NULL,
  `label` varchar(30) CHARACTER SET latin1 NOT NULL,
  `entity` int(11) NOT NULL DEFAULT '1',
  `fk_user_author` int(11) DEFAULT NULL,
  `fk_user_modif` int(11) DEFAULT NULL,
  `bank` varchar(60) CHARACTER SET latin1 DEFAULT NULL,
  `code_banque` varchar(128) CHARACTER SET latin1 DEFAULT NULL,
  `code_guichet` varchar(6) CHARACTER SET latin1 DEFAULT NULL,
  `number` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `cle_rib` varchar(5) CHARACTER SET latin1 DEFAULT NULL,
  `bic` varchar(11) CHARACTER SET latin1 DEFAULT NULL,
  `iban_prefix` varchar(34) CHARACTER SET latin1 DEFAULT NULL,
  `country_iban` varchar(2) CHARACTER SET latin1 DEFAULT NULL,
  `cle_iban` varchar(2) CHARACTER SET latin1 DEFAULT NULL,
  `domiciliation` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `pti_in_ctti` smallint(6) DEFAULT '0',
  `state_id` int(11) DEFAULT NULL,
  `fk_pays` int(11) NOT NULL,
  `proprio` varchar(60) CHARACTER SET latin1 DEFAULT NULL,
  `owner_address` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  ...
  `account_number` varchar(32) CHARACTER SET latin1 DEFAULT NULL,
  ...
  `import_key` varchar(14) CHARACTER SET latin1 DEFAULT NULL,
  `extraparams` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `ics` varchar(32) CHARACTER SET latin1 DEFAULT NULL,
  `ics_transfer` varchar(32) CHARACTER SET latin1 DEFAULT NULL,
  PRIMARY KEY (`rowid`),
...
CREATE TABLE IF NOT EXISTS `llx_bank_account_extrafields` (
  ...
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) CHARACTER SET latin1 DEFAULT NULL,
  `b01` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `alias01` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  PRIMARY KEY (`rowid`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1293 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE IF NOT EXISTS `llx_blockedlog` (
  ...
  `element` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `fk_user` int(11) DEFAULT NULL,
  `user_fullname` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `fk_object` int(11) DEFAULT NULL,
  `ref_object` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `date_object` datetime DEFAULT NULL,
  `signature` varchar(100) CHARACTER SET latin1 NOT NULL,
  `signature_line` varchar(100) CHARACTER SET latin1 NOT NULL,
  `object_data` mediumtext CHARACTER SET latin1,
  `object_version` varchar(32) CHARACTER SET latin1 DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `llx_blockedlog_authority` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `blockchain` longtext CHARACTER SET latin1 NOT NULL,
  `signature` varchar(100) CHARACTER SET latin1 NOT NULL,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`rowid`),
  KEY `signature` (`signature`)
...
CREATE TABLE IF NOT EXISTS `llx_bookmark` (
  ...
  `favicon` varchar(24) CHARACTER SET latin1 DEFAULT NULL,
  `position` int(11) DEFAULT '0',
  `entity` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`rowid`),
...
CREATE TABLE IF NOT EXISTS `llx_boxes` (
  ...
  `box_order` varchar(3) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `llx_boxes_def` (
  ...
  `entity` int(11) NOT NULL DEFAULT '1',
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `note` varchar(130) CHARACTER SET latin1 DEFAULT NULL,
  `fk_user` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`rowid`),
...
CREATE TABLE IF NOT EXISTS `llx_budget_lines` (
  ...
  `fk_project_ids` varchar(180) CHARACTER SET latin1 NOT NULL,
  `amount` double(24,8) NOT NULL,
  `datec` datetime DEFAULT NULL,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fk_user_creat` int(11) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_c_asset_disposal_type` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `entity` int(11) NOT NULL DEFAULT '1',
  `code` varchar(16) COLLATE utf8_spanish_ci NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_c_partnership_type` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `entity` int(11) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `llx_categorie` (
  ...
  `entity` int(11) NOT NULL DEFAULT '1',
  `fk_parent` int(11) NOT NULL DEFAULT '0',
  `label` varchar(180) CHARACTER SET latin1 NOT NULL,
  `ref_ext` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `type` int(11) NOT NULL DEFAULT '1',
  `description` text CHARACTER SET latin1,
  `color` varchar(8) CHARACTER SET latin1 DEFAULT NULL,
  `fk_soc` int(11) DEFAULT NULL,
  `visible` tinyint(4) NOT NULL DEFAULT '1',
  `date_creation` datetime DEFAULT NULL,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Table structure for table `llx_cotizaciones_cotizacion`
--

DROP TABLE IF EXISTS `llx_cotizaciones_cotizacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_cotizaciones_cotizacion` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `ref` varchar(128) COLLATE utf8_spanish_ci NOT NULL DEFAULT '(PROV)',
  `Usuario` int(11) DEFAULT NULL,
  `fk_soc` int(11) DEFAULT NULL,
  `trabajo` varchar(128) COLLATE utf8_spanish_ci DEFAULT NULL,
  `fk_project` int(11) DEFAULT NULL,
  ...
  `model_pdf` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `status` int(11) NOT NULL,
  `C0Ro` int(11) DEFAULT '1',
  `C0Pr` double DEFAULT NULL,
  `C0Ca` varchar(128) COLLATE utf8_spanish_ci DEFAULT '1',
  `C0As` int(11) DEFAULT NULL,
  `C0Pa` double DEFAULT NULL,
  `C1Ro` int(11) DEFAULT NULL,
  `C1Pr` double DEFAULT '800',
  `C1Ca` varchar(128) COLLATE utf8_spanish_ci DEFAULT '1',
  `C1As` int(11) DEFAULT NULL,
  `C1Pa` double DEFAULT NULL,
  `C2Ro` int(11) DEFAULT '3',
  `C2Pr` double DEFAULT NULL,
  `C2Ca` varchar(128) COLLATE utf8_spanish_ci DEFAULT '1',
  `C2As` int(11) DEFAULT NULL,
  `C2Pa` double DEFAULT NULL,
  `C3Ro` int(11) DEFAULT '2',
  `C3Pr` double DEFAULT NULL,
  `C3Ca` varchar(128) COLLATE utf8_spanish_ci DEFAULT '1',
  `C3As` int(11) DEFAULT NULL,
  `C3Pa` double DEFAULT NULL,
  `C4Ro` int(11) DEFAULT '11',
  `C4Pr` double DEFAULT NULL,
  `C4Ca` varchar(128) COLLATE utf8_spanish_ci DEFAULT '1',
  `C4As` int(11) DEFAULT NULL,
  `C4Pa` double DEFAULT NULL,
  `C5Ro` int(11) DEFAULT '7',
  `C5Pr` double DEFAULT NULL,
  `C5Ca` varchar(128) COLLATE utf8_spanish_ci DEFAULT '1',
  `C5As` int(11) DEFAULT NULL,
  `C5Pa` double DEFAULT NULL,
  `C6Ro` int(11) DEFAULT '8',
  `C6Pr` double DEFAULT NULL,
  `C6Ca` varchar(128) COLLATE utf8_spanish_ci DEFAULT '1',
  `C6As` int(11) DEFAULT NULL,
  `C6Pa` double DEFAULT NULL,
  `C7Ro` int(11) DEFAULT NULL,
  `C7Pr` double DEFAULT NULL,
  `C7Ca` varchar(128) COLLATE utf8_spanish_ci DEFAULT '1',
  `C7As` int(11) DEFAULT NULL,
  `C7Pa` double DEFAULT NULL,
  `C8Ro` int(11) DEFAULT NULL,
  `C8Pr` double DEFAULT NULL,
  `C8Ca` varchar(128) COLLATE utf8_spanish_ci DEFAULT '1',
  `C8As` int(11) DEFAULT NULL,
  `C8Pa` double DEFAULT NULL,
  `C9Ro` int(11) DEFAULT NULL,
  `C9Pr` double DEFAULT NULL,
  `C9Ca` varchar(128) COLLATE utf8_spanish_ci DEFAULT '1',
  `C9As` int(11) DEFAULT NULL,
  `C9Pa` double DEFAULT NULL,
  `facturacion` int(11) NOT NULL,
  PRIMARY KEY (`rowid`),
  KEY `idx_cotizaciones_cotizacion_rowid` (`rowid`),
  KEY `idx_cotizaciones_cotizacion_ref` (`ref`),
  KEY `idx_cotizaciones_cotizacion_fk_soc` (`fk_soc`),
  KEY `idx_cotizaciones_cotizacion_fk_project` (`fk_project`),
  KEY `llx_cotizaciones_cotizacion_fk_user_creat` (`fk_user_creat`),
  KEY `idx_cotizaciones_cotizacion_status` (`status`),
  KEY `idx_cotizaciones_cotizacion_C0Ro` (`C0Ro`),
  KEY `idx_cotizaciones_cotizacion_C1Ro` (`C1Ro`),
  KEY `idx_cotizaciones_cotizacion_C2Ro` (`C2Ro`),
  KEY `idx_cotizaciones_cotizacion_C3Ro` (`C3Ro`),
  KEY `idx_cotizaciones_cotizacion_C4Ro` (`C4Ro`),
  KEY `idx_cotizaciones_cotizacion_C5Ro` (`C5Ro`),
  KEY `idx_cotizaciones_cotizacion_C6Ro` (`C6Ro`),
  KEY `idx_cotizaciones_cotizacion_C7Ro` (`C7Ro`),
  KEY `idx_cotizaciones_cotizacion_C8Ro` (`C8Ro`),
  KEY `idx_cotizaciones_cotizacion_C9Ro` (`C9Ro`),
  CONSTRAINT `llx_cotizaciones_cotizacion_fk_user_creat` FOREIGN KEY (`fk_user_creat`) REFERENCES `llx_user` (`rowid`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `llx_cotizaciones_cotizacion_extrafields`
--

DROP TABLE IF EXISTS `llx_cotizaciones_cotizacion_extrafields`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_cotizaciones_cotizacion_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`rowid`),
  KEY `idx_cotizacion_fk_object` (`fk_object`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE IF NOT EXISTS `llx_facture_fourn_det_rec` (
  ...
  `fk_parent_line` int(11) DEFAULT NULL,
  `fk_product` int(11) DEFAULT NULL,
  `ref` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `label` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `description` text COLLATE utf8_spanish_ci,
  `pu_ht` double(24,8) DEFAULT NULL,
  `pu_ttc` double(24,8) DEFAULT NULL,
  ...
  `remise_percent` double DEFAULT '0',
  `fk_remise_except` int(11) DEFAULT NULL,
  `vat_src_code` varchar(10) COLLATE utf8_spanish_ci DEFAULT '',
  `tva_tx` double(7,4) DEFAULT NULL,
  `localtax1_tx` double(7,4) DEFAULT '0.0000',
  `localtax1_type` varchar(10) COLLATE utf8_spanish_ci DEFAULT NULL,
  `localtax2_tx` double(7,4) DEFAULT '0.0000',
  `localtax2_type` varchar(10) COLLATE utf8_spanish_ci DEFAULT NULL,
  `total_ht` double(24,8) DEFAULT NULL,
  ...
  `fk_user_modif` int(11) DEFAULT NULL,
  `fk_multicurrency` int(11) DEFAULT NULL,
  `multicurrency_code` varchar(3) COLLATE utf8_spanish_ci DEFAULT NULL,
  `multicurrency_subprice` double(24,8) DEFAULT '0.00000000',
  `multicurrency_total_ht` double(24,8) DEFAULT '0.00000000',
  `multicurrency_total_tva` double(24,8) DEFAULT '0.00000000',
  `multicurrency_total_ttc` double(24,8) DEFAULT '0.00000000',
...
CREATE TABLE IF NOT EXISTS `llx_facture_fourn_extrafields` (
  ...
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
  `recepciodefactura` varchar(255) DEFAULT '1',
  PRIMARY KEY (`rowid`),
...
CREATE TABLE IF NOT EXISTS `llx_facture_fourn_rec` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `titre` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
  `ref_supplier` varchar(180) COLLATE utf8_spanish_ci NOT NULL,
  `entity` int(11) NOT NULL DEFAULT '1',
  `fk_soc` int(11) NOT NULL,
  `datec` datetime DEFAULT NULL,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `suspended` int(11) DEFAULT '0',
  `libelle` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `amount` double(24,8) NOT NULL DEFAULT '0.00000000',
  `remise` double DEFAULT '0',
  `vat_src_code` varchar(10) COLLATE utf8_spanish_ci DEFAULT '',
  `localtax1` double(24,8) DEFAULT '0.00000000',
  ...
  `note_private` text COLLATE utf8_spanish_ci,
  `note_public` text COLLATE utf8_spanish_ci,
  `modelpdf` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `fk_multicurrency` int(11) DEFAULT NULL,
  `multicurrency_code` varchar(3) COLLATE utf8_spanish_ci DEFAULT NULL,
  `multicurrency_tx` double(24,8) DEFAULT '1.00000000',
  `multicurrency_total_ht` double(24,8) DEFAULT '0.00000000',
  ...
  `unit_frequency` varchar(2) COLLATE utf8_spanish_ci DEFAULT 'm',
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_hrm_evaluation` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_hrm_evaluation_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_hrm_evaluationdet` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `date_creation` datetime NOT NULL,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `fk_user_creat` int(11) NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_hrm_evaluationdet_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_hrm_job` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `label` varchar(255) NOT NULL,
  `description` text,
  `date_creation` datetime NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_hrm_job_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_hrm_job_user` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `description` text,
  `date_creation` datetime NOT NULL,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_hrm_skill` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `label` varchar(255) DEFAULT NULL,
  `description` text,
  `date_creation` datetime NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_hrm_skill_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_hrm_skilldet` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `description` text,
  `fk_user_creat` int(11) NOT NULL,
  `fk_user_modif` int(11) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_hrm_skillrank` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `fk_skill` int(11) NOT NULL,
  `rankorder` int(11) NOT NULL,
  `fk_object` int(11) NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_intracommreport` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `ref` varchar(30) NOT NULL,
  `entity` int(11) NOT NULL DEFAULT '1',
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_knowledgemanagement_knowledgerecord_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_mailing_advtarget` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(180) CHARACTER SET latin1 NOT NULL,
  `entity` int(11) NOT NULL DEFAULT '1',
  `fk_element` int(11) NOT NULL,
  `type_element` varchar(180) CHARACTER SET latin1 NOT NULL,
  `filtervalue` text CHARACTER SET latin1,
  `fk_user_author` int(11) NOT NULL,
  `datec` datetime NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_partnership` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `ref` varchar(128) NOT NULL DEFAULT '(PROV)',
  `status` smallint(6) NOT NULL DEFAULT '0',
  `fk_soc` int(11) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_partnership_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_recruitment_recruitmentcandidature` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `entity` int(11) NOT NULL DEFAULT '1',
  `ref` varchar(128) NOT NULL DEFAULT '(PROV)',
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_recruitment_recruitmentcandidature_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_recruitment_recruitmentjobposition` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `ref` varchar(128) NOT NULL DEFAULT '(PROV)',
  `entity` int(11) NOT NULL DEFAULT '1',
  `label` varchar(255) NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_recruitment_recruitmentjobposition_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_societe_perentity` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `fk_soc` int(11) DEFAULT NULL,
  `entity` int(11) NOT NULL DEFAULT '1',
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_workstation_workstation` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `ref` varchar(128) NOT NULL DEFAULT '(PROV)',
  `label` varchar(255) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_workstation_workstation_resource` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_workstation_workstation_usergroup` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fk_usergroup` int(11) DEFAULT NULL,
  `fk_workstation` int(11) DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `llx_zapier_hook` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `entity` int(11) NOT NULL DEFAULT '1',
  `url` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2023-05-17 18:27:48
