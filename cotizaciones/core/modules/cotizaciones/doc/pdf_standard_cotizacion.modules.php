...
/**
 *  \file       core/modules/cotizaciones/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_cotizacion
 */
class pdf_standard_cotizacion extends ModelePDFCotizacion
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_COTIZACION_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->cotizaciones->dir_output.'/cotizacion') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->cotizaciones->dir_output.'/cotizacion';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->cotizaciones->dir_output.'/cotizacion/'.$objectref;
