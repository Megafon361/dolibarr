...
/**
 *  \file       cotizacion_note.php
 *  \ingroup    cotizaciones
 *  \brief      Tab for notes on Cotizacion
 */
...
$langs->loadLangs(array("cotizaciones@cotizaciones", "companies"));
...
$hookmanager->initHooks(array('cotizacionnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Cotizacion'), $help_url);
