...
/**
 * \file    cotizaciones/core/boxes/cotizacioneswidget1.php
 * \ingroup cotizaciones
 * \brief   Widget provided by Cotizaciones
 *
 ...
 */
class cotizacioneswidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "cotizacionesbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "cotizaciones@cotizaciones";
	 ...
	 */
	public $depends = array('cotizaciones');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "cotizaciones@cotizaciones"));
		...
		//$this->hidden = ! ($user->rights->cotizaciones->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/cotizaciones/class/cotizaciones.class.php");

		// Populate the head at runtime
		$text = $langs->trans("CotizacionesBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_cotizaciones@cotizaciones',
