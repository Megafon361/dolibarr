...
/**
 * \file    test/phpunit/CotizacionesFunctionalTest.php
...
/**
 * Class CotizacionesFunctionalTest
 *
 ...
 *
 * @package Testcotizaciones
 */
class CotizacionesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modCotizaciones')->click();
		} else {
			// Disable the module
			$this->byHref('modCotizaciones')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/cotizaciones/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('cotizaciones/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/cotizaciones/admin/about.php');
		$this->authenticate();
		return $this->assertContains('cotizaciones/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('cotizacioneswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCotizaciones_CotizacionesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCotizaciones_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
